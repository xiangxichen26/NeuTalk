            ...
            <div class="loginForm" v-if="showLoginForm">
                ...
                <el-form class="loginInputForm">
                    <el-form-item class="loginInputItem">
                        <el-input placeholder="please input username" :prefix-icon="User" v-model="loginForm.username"></el-input>
                    </el-form-item>
                    <el-form-item class="loginInputItem">
                        <el-input placeholder="please input password" :prefix-icon="Lock" type="password" v-model="loginForm.password"></el-input>
                    </el-form-item>
                ...
                <div class="linkToRegister">
                    ...
                    <el-link :underline="false" type="primary" @click="showLoginForm = false">Register</el-link>
                </div>
            </div>
            ...
            <div class="registerForm" v-if="showLoginForm === false">
                ...
                <el-form class="registerInputForm">
                    <el-form-item class="registerInputItem">
                        <el-input placeholder="please input username" :prefix-icon="User" v-model="registerForm.username"></el-input>
                    </el-form-item>
                    <el-form-item class="registerInputItem">
                        <el-input placeholder="please input password" :prefix-icon="Lock" v-model="registerForm.password"></el-input>
                    </el-form-item>
